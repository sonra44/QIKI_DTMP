...
## Сбор контекста
- [Факт] Определяет пути к основным `main.py` сервисов.
- [Факт] Создаёт директорию логов `.agent/logs/<date>` и сохраняет stdout каждого сервиса.
- [Факт] Запускает оба сервиса в фоне и выводит инструкцию по их остановке.
