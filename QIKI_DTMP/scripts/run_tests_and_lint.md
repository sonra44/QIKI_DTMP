...
- [Факт] Выполняет `pytest` для `services/q_core_agent/tests/` и `ruff check` для каталога агента【F:scripts/run_tests_and_lint.sh†L13-L18】.
- [Факт] Проверяет синтаксис всех `.proto` файлов через `protoc`【F:scripts/run_tests_and_lint.sh†L20-L23】.
