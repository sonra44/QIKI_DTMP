...
- Client-side disconnect/auth failure keeps the recorded state consistent (`NO_DATA` + `SESSION LOST` snapshot path retained from TASK-0031.D1).
...
- `QIKI_SESSION_ROLE` (client requested role)
