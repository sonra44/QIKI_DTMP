# TASK: ORION indent repair and UI logs are non-silent on failures

**ID:** TASK_20260127_ORION_INDENT_REPAIR_AND_UI_LOGS  
**Status:** completed (verified 2026-02-09)  

## Goal

ORION UI maintenance actions must not swallow exceptions silently.

## Implementation / Evidence

- ORION no longer has `except Exception: pass`:
