...
- [x] Mypy baseline reduced to <= 110 errors
- [x] No new mypy errors introduced in changed files during sprint
- [x] Progress checkpoints recorded with commands and counts
- [x] Canon docs synced if policy changed
