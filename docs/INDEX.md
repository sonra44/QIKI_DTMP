...
9. `CONTEXT/CURRENT_STATE.md` — срез состояния (2025-09-27) и “что ещё не сделано”.
10. `CURRENT_STATE.md` — более свежий срез (обновлялся позже; сверять с `CONTEXT/CURRENT_STATE.md`).
