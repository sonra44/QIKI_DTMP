...
- Изменения задокументированы (обновлён `README.md` и task‑досье в `TASKS/` при необходимости; канон приоритетов — `~/MEMORI/ACTIVE_TASKS_QIKI_DTMP.md`), подготовлен корректный коммит.
