...
## 8) Hardware contracts: формат и сборка профиля
...
## 9) Каноничные машиночитаемые артефакты (приоритет выше текста)
...
## 10) Связанные документы (не «источник правды»)
