...
BIOS — низкоуровневая «прошивка» бота. На старте она читает `bot_physical_specs.json`, выполняет POST‑проверки по всем портам, формирует отчёт `bios_status` и публикует готовность/ошибки.  
