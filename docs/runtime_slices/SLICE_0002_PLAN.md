# RUNTIME_SLICE_0002 — ORION Evidence Card Surfacing for Body Structure Rejection — STATUS
...
`audit-backed attach rejection is projected as a read-only Evidence Card`

Proof marker:

`BODY_MODULE_ATTACH_REJECTION / MODULE_PASSPORT_MISSING`
