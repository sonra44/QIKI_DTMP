# RUNTIME_SLICE_0006 — Module Passport Integrity Guard / Invalid Passport Rejection — STATUS
...
`present but structurally invalid passport is rejected before mount validation`
