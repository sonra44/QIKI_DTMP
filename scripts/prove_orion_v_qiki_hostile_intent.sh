...
printf '\n[prove] live ORION V hostile-intent arbitration smoke\n'
docker compose -f docker-compose.phase1.yml exec -T qiki-dev python tools/orion_v_qiki_hostile_intent_smoke.py
