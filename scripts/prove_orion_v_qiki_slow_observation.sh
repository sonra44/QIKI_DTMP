...
printf '\n[prove] live ORION V QIKI slow-observation smoke\n'
docker compose -f docker-compose.phase1.yml exec -T qiki-dev python tools/orion_v_qiki_slow_observation_smoke.py
