...
class MissionControlDemo:
    ...
    def render_interface(self):
        ...
        print("┌─ SPACECRAFT TELEMETRY ──────────────────────────┐ ┌─ MISSION LOG ─────────────────────────────────────────────────────┐")
        ...
        for i in range(max(len(telemetry_lines), len(log_entries))):
            left = telemetry_lines[i] if i < len(telemetry_lines) else "│                                                   │"
            right = ""
        ...
        mode_color = {"idle": "🟢", "maneuvering": "🟡", "cruise": "🔵", "emergency": "🔴"}.get(telemetry['propulsion_mode'], "⚪")
