...
class ShipFSMHandler(IFSMHandler):
    ...
    def process_fsm_state(self, current_fsm_state: FSMState) -> FSMState:
        ...
        logger.debug(f"Processing ship FSM state: {current_fsm_state.current_state_name}")
...
if __name__ == "__main__":
    try:
        ...
        for i in range(5):
            ...
            if i > 0 and current_state.current_state_name == next_state.current_state_name:
