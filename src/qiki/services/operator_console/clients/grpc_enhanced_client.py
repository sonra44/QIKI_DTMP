...
class EnhancedGrpcClient:
    ...
    async def _reconnect_loop(self):
        ...
        while attempts < self.max_reconnect_attempts:
            ...
            if self.sim_state == ConnectionState.CONNECTED and self.agent_state == ConnectionState.CONNECTED:
    ...
    async def send_command(self, command: SimulationCommand, **kwargs) -> CommandResponse:
        ...
        if self.sim_state != ConnectionState.CONNECTED:
            return CommandResponse(
                success=False, message="Not connected to simulation service", error="CONNECTION_ERROR"
            )
        ...
        try:
            ...
            return CommandResponse(success=False, message=f"Command failed: {str(e)}", error=str(e))
    ...
    async def send_chat_message(self, message: ChatMessage) -> ChatResponse:
        ...
        try:
            ...
            return ChatResponse(
                text=f"Error: {str(e)}", language=message.language, confidence=0.0, metadata={"error": str(e)}
            )
    ...
    async def get_simulation_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "running", "scenario": "default", "time_elapsed": 1234.5, "entities": 5}
        except Exception as e:
    ...
    async def get_agent_status(self) -> Dict[str, Any]:
        ...
        try:
            # Would call actual gRPC method
            return {"status": "active", "model": "QIKI-v2", "conversations": 3, "avg_response_time": 0.25}
        except Exception as e:
            return {"status": "error", "error": str(e)}
    ...
    def get_connection_states(self) -> Dict[str, ConnectionState]:
        ...
        return {"simulation": self.sim_state, "agent": self.agent_state}
