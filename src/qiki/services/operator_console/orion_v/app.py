...
class OrionVApp(App[None]):
    ...
    BINDINGS = [
        ...
        # подсказки пульта пишут клавиши заглавными (B корпус | R сброс | H справка) —
        # верхний регистр обязан работать так же, как нижний
        ("b,B", "run_body_structure_self_check", "BODY attach"),
        ("n,N", "select_next_body_structure_face", "BODY face next"),
        ("p,P", "select_previous_body_structure_face", "BODY face prev"),
        ...
        ("e,E", "show_level('f8')", "BODY evidence"),
        ("r,R", "reset_body_structure_self_check", "BODY reset"),
        ...
        ("h,H", "cockpit_toggle_help", "F1 help"),
