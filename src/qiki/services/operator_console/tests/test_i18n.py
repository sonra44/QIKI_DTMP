...
from qiki.services.operator_console.core.i18n import I18n, get_i18n
...
class TestI18n:
    ...
    def test_translate_with_parameters(self):
        ...
        result = i18n.translate("messages.simulation_status", simulation_id="sim_123", status="RUNNING")
    ...
    def test_translate_with_parameters_russian(self):
        ...
        # Test message with parameters
        result = i18n.translate("messages.simulation_status", simulation_id="sim_123", status="ЗАПУЩЕНА")
    ...
    def test_format_message_multiple_params(self):
        ...
        result = i18n._format_message(message, user="operator", sim_id="sim_001", time="12:30")
...
class TestI18nSingleton:
    ...
    def test_singleton_initialization_once(self):
        ...
        import qiki.services.operator_console.core.i18n as i18n_module
...
class TestI18nTranslations:
    ...
    def test_button_translations(self, en_i18n, ru_i18n):
        ...
        buttons = ["start_simulation", "stop_simulation", "send_message", "clear_chat", "export_data"]
    ...
    def test_status_translations(self, en_i18n, ru_i18n):
        ...
        statuses = ["connected", "disconnected", "connecting", "error", "running", "stopped"]
    ...
    def test_panel_translations(self, en_i18n, ru_i18n):
        ...
        panels = ["simulation", "chat", "metrics", "logs"]
