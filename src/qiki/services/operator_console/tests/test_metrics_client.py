...
from qiki.services.operator_console.clients.metrics_client import (
    MetricsClient,
    MetricPoint,
    MetricSeries,
)
...
class TestMetricSeries:
    ...
    def test_metric_series_creation(self):
        ...
        series = MetricSeries(name="test.metric", points=points, unit="ms", description="Test metric")
...
class TestMetricsClient:
    ...
    def test_collect_system_metrics(self, client):
        ...
        with (
            patch("qiki.services.operator_console.clients.metrics_client.psutil.cpu_percent") as mock_cpu,
            patch("qiki.services.operator_console.clients.metrics_client.psutil.virtual_memory") as mock_memory,
        ):
