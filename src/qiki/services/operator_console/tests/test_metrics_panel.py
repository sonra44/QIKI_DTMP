...
class TestMetricsPanel:
    ...
    def test_create_recent_metrics_with_data(self, panel, metrics_client):
        ...
        for name, value in latest.items():
            ...
            recent.append({"name": name, "value": value, "unit": metric.unit, "timestamp": metric.points[-1].timestamp})
    ...
    @patch("qiki.services.operator_console.widgets.metrics_panel.MetricsPanel._create_summary_table")
    @patch("qiki.services.operator_console.widgets.metrics_panel.MetricsPanel._create_recent_metrics")
