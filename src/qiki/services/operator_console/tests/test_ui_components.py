...
class TestOperatorConsoleApp:
    ...
    async def test_init_nats_client(self, app):
        ...
        with patch('clients.nats_client.NATSClient') as mock_nats_class:
    ...
    async def test_init_grpc_clients(self, app):
        ...
        with patch('clients.grpc_client.QSimGrpcClient') as mock_sim_class:
            with patch('clients.grpc_client.QAgentGrpcClient') as mock_agent_class:
