...
class BiosConfig:
    """Runtime config for the support-tier derived BIOS/status projection service."""
    ...
    # The default subject is the only canonical v1 BIOS status event contract.
    # Overriding it is for non-canonical/dev wiring only and falls outside the
    # documented AsyncAPI contract in schemas/asyncapi/qiki.events.v1.bios_status/v1/.
