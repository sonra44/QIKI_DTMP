...
class MCQPUTelemetry:
    ...
    def _compute_cpu_demand_pct(
        ...
        *,
        ...
        queue_load = self.config.sensor_queue_coeff * int(sensor_queue_depth) + self.config.actuator_queue_coeff * int(
    ...
    def update(
        ...
        *,
        ...
        self.state.memory_usage_pct = self._clamp(
            self.state.memory_usage_pct + alpha_ram * (mem_target - self.state.memory_usage_pct),
            0.0,
            100.0,
        )
