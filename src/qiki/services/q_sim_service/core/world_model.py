...
from qiki.shared.models.thermal import (
    ThermalTelemetryRecord,  # noqa: F401  (re-exported for q_sim consumers/tests)
    _thermal_state_from_node,
    thermal_telemetry_from_thermal_state,
)
from qiki.shared.models.comms import CommsChannelRecord, comms_channels_from_comms_state  # noqa: F401
from qiki.shared.models.sensors import SensorTelemetryRecord, sensor_telemetry_from_sensor_plane  # noqa: F401
from qiki.shared.models.pdu import PduPermissionRecord, pdu_permissions_from_power_state  # noqa: F401
from qiki.shared.models.rcs import RcsCommandRecord, rcs_command_from_runtime_state  # noqa: F401
...
# ThermalTelemetryRecord moved to qiki.shared.models.thermal (DEFERRED-A); imported at top.


# PduPermissionRecord moved to qiki.shared.models.pdu (PDU §11 Slice); imported at top.


# SensorTelemetryRecord moved to qiki.shared.models.sensors (Slice A); imported at top.


# CommsChannelRecord moved to qiki.shared.models.comms (DEFERRED-A); imported at top.


# RcsCommandRecord moved to qiki.shared.models.rcs (RCS §14 Slice); imported at top.
...
# Thermal §13.7 record + pure mapper (_thermal_state_from_node / _thermal_reason_codes /
# _thermal_blocked_commands / thermal_telemetry_from_thermal_state) moved to
# qiki.shared.models.thermal (DEFERRED-A) and imported at the top of this module.


# _PDU_PEAK_LOADS / _PDU_LOAD_CLASSES moved to qiki.shared.models.pdu (PDU §11 Slice).
...
# PDU §11 record + pure mapper (_thermal_blocked_loads / _pdu_state / _pdu_reason_codes /
# _pdu_allowance_state / pdu_permissions_from_power_state) moved to qiki.shared.models.pdu
# (PDU §11 Slice); imported at the top of this module.


# Sensor §15 record + pure mapper (_sensor_thermal_state / _sensor_reason_codes /
# _sensor_trust_status / _sensor_record / sensor_telemetry_from_sensor_plane) moved to
# qiki.shared.models.sensors (Slice A); imported at the top of this module.


# Comms §16 record + pure mapper (_comms_bandwidth_class / _comms_thermal_blocked /
# _comms_power_blocked / _comms_delivery_state / _comms_reason_codes /
# _comms_delivery_state_from_reason_codes / _comms_trust_status /
# comms_channels_from_comms_state) moved to qiki.shared.models.comms (DEFERRED-A);
# imported at the top of this module.


# RCS §14 record + pure mapper (_rcs_thruster_ids / _rcs_active_clusters / _rcs_hot_nodes /
# _rcs_bridge_state / _rcs_bayonet_state / _rcs_reason_codes / rcs_command_from_runtime_state)
# moved to qiki.shared.models.rcs (RCS §14 Slice); imported at the top of this module.
