...
"""Alternate legacy-compatible QIKI ingress over plain NATS request/reply.

This service remains runnable, but it is not the canonical QIKI ingress contour in
QIKI_DTMP. The supported canonical path is q-core-intents on
