...
def test_registrar_with_event_codes():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        event = RegistrarEvent(
            ...
            payload={"event_code": RegistrarCode.BOOT_OK, "description": "System boot completed successfully"},
        )
...
def test_multiple_events_with_different_codes():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        boot_event = RegistrarEvent(
            ...
            source="system",
            timestamp=datetime.now(timezone.utc),
            payload={"event_code": RegistrarCode.BOOT_OK, "description": "System boot completed"},
        )
        ...
        sensor_event = RegistrarEvent(
            ...
            source="radar_01",
            timestamp=datetime.now(timezone.utc),
            payload={"event_code": RegistrarCode.RADAR_FRAME_RECEIVED, "description": "Radar frame received"},
        )
        ...
        comm_event = RegistrarEvent(
            ...
            source="nats_client",
            timestamp=datetime.now(timezone.utc),
            payload={"event_code": RegistrarCode.NATS_CONNECTED, "description": "NATS connection established"},
        )
