"""
Standalone shell_os — Textual TUI service (no-mocks).
...
This service is a supported diagnostic/support shell overlay. It is not ORION V,
not the canonical operator surface, and not a competing operator UI path.
"""
