...
class VelocityVectorTelemetry(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class OrbitTelemetry(BaseModel):
    model_config = ConfigDict(extra="forbid")

    state: str = "off"
    reason: str = ""
    confidence: float = Field(default=0.0, ge=0.0, le=1.0)
    apoapsis_km: float | None = Field(default=None, ge=0.0)
    periapsis_km: float | None = Field(default=None, ge=0.0)
    inclination_deg: float | None = None
    eccentricity: float | None = Field(default=None, ge=0.0, le=1.0)
    period_min: float | None = Field(default=None, ge=0.0)


class CommsTelemetry(BaseModel):
    ...
    snr_db: float | None = Field(default=None, ge=0.0)
    tx_power_w: float | None = Field(default=None, ge=0.0)
    data_rate_kbps: float | None = Field(default=None, ge=0.0)
    antenna_status: str | None = None
    plane_enabled: bool | None = None
    plane_profile: str | None = None
...
class PropulsionTelemetry(BaseModel):
    ...
    propellant_tank_pressure_pa: float | None = Field(default=None, ge=0.0)
    oxidizer_mass_kg: float | None = Field(default=None, ge=0.0)
...
class TelemetrySnapshotModel(BaseModel):
    ...
    velocity_xyz_m_s: VelocityVectorTelemetry | None = None
    heading: float
    ...
    orbit: OrbitTelemetry | None = None
    comms: CommsTelemetry | None = None
    propulsion: PropulsionTelemetry | None = None
