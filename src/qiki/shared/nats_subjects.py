...
OPERATOR_PROCEDURES = "qiki.events.v1.operator.procedures"
OPERATOR_INCIDENTS = "qiki.events.v1.operator.incidents"
OPERATOR_COMBAT = "qiki.events.v1.operator.combat"
OPERATOR_OBJECTIVES = "qiki.events.v1.operator.objectives"
...
SIM_POWER_PDU = "qiki.events.v1.power.pdu"

# Radar guard alerts (published by radar processing pipeline)
RADAR_GUARD_ALERTS = "qiki.events.v1.radar.guard"
