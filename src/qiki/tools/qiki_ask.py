...
"""Manual client for the alternate non-canonical `qiki.chat.v1` ingress."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Ask QIKI over the alternate legacy-compatible qiki.chat.v1 NATS request/reply path."
    )
