...
def main():
    ...
    subparsers.add_parser("compile-protos", help="Скомпилировать все .proto контракты.")

    # --- Команда 'build-readme' ---
    subparsers.add_parser("build-readme", help="Собрать главный README.md из документов.")
