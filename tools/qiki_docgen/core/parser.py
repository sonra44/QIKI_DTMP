...
class ProtoParser:
    ...
    def parse_proto_file(self, proto_file_path: Path) -> Dict[str, Any]:
        ...
        if not proto_file_path.exists():
            ...
            return {"file_path": str(proto_file_path), "messages": [], "enums": [], "services": [], "package": ""}
...
class DesignDocParser:
    ...
    def parse_design_doc(self, design_doc_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            component_name = self._determine_component_name(metadata, sections, design_doc_path)
    ...
    def _determine_component_name(self, metadata: Dict[str, Any], sections: Dict[str, str], file_path: Path) -> str:
