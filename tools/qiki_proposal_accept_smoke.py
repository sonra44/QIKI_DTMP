...
async def _request_once(
    ...
    *,
    ...
    try:
        ...
        timeout_s = float(os.getenv("QIKI_PROPOSAL_ACCEPT_SMOKE_TIMEOUT_SEC", "5.0"))
        ...
        try:
            ...
            print("WARN: qiki_proposal_accept_smoke unsubscribe failed", file=sys.stderr)
...
async def main() -> int:
    ...
    try:
        ...
        if title.lower() != "accepted":
            ...
            return 1
        print(f"OK: accepted proposal_id={pid}")
        return 0
    except TimeoutError:
